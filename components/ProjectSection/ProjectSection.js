    ...
    return (
        <div className="wpo-project-area section-padding" id='portfolio'>
            <div className="container">
                <div className="wpo-section-title-s2">
                    <div className="row align-items-center">
                        <div className="col-lg-4 col-12">
                            <div className="title">
                                <h2>Recent Work</h2>
                                {/* <p>Showcasing my latest design projects and creative solutions for various clients and industries.</p> */}
                            </div>
                        </div>
                ...
                <div className="wpo-project-wrap wpo-project-slide mt-5">
                    <Slider {...settings}>
                        {Projects.map((project, pro) => (
                            <div className="wpo-project-item" key={pro}>
                                <div className="wpo-project-img" style={{height: "400px", overflow: "hidden"}}>
                                    <img src={project.pImg} alt="" style={{width: "100%", height: "100%", objectFit: "cover"}} />
                                </div>
